	...
	var options = {
		...
		tooltip: {
			...
			y: {
				...
				formatter: (value) => { return 'R$ '+ convertNumberWithCommas(value) },
			},
			marker: {
				show: false
			}
...
var handleVisitorsDonutChart = function() {
	var visitorDonutChartData = [
		{ 'label': 'Pessoa Civil', 'value' : 161983, 'color': COLOR_GREEN }, 
		{ 'label': 'Pessoa Jurídica', 'value' : 98347, 'color': COLOR_BLUE }
	];
	var arcRadius = [
		{ inner: 0.6, outer: 1 },
		{ inner: 0.6, outer: 1 }
