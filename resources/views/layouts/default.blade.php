...
<body class="{{ $bodyClass }}">
	...
	<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed {{ $pageContainerClass }}">
		...
		@include('controle.includes.header')

		@includeWhen($topMenu, 'controle.includes.top-menu')

		@includeWhen(!$sidebarHide, 'controle.includes.sidebar')

		@includeWhen($sidebarTwo, 'includes.controle.sidebar-right')

		<div id="content" class="content {{ $contentClass }}">
			@yield('content')
		</div>

		@includeWhen($footer, 'controle.includes.footer')

		@include('controle.includes.component.theme-panel')

		@include('controle.includes.component.scroll-top-btn')
